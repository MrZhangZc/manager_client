<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-select v-model="listQuery.year" clearable="" placeholder="请选择" @change="handleFilter">
        <el-option
      ...
      <el-select v-model="listQuery.month" clearable="" placeholder="请选择" @change="handleFilter">
        <el-option
...
<script>
import { addModel, updateModel, deleteModel } from "@/api/user";
import { loginStat } from "@/api/user";
...
export default {
  ...
  methods: {
    getList() {
      ...
      loginStat(this.listQuery).then(response => {
